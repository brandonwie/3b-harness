...
from interview_plugin_core.brownfield import detect_brownfield
from interview_plugin_core.config import get_default_model, get_default_state_dir
from interview_plugin_core.errors import ProviderError, ValidationError
from interview_plugin_core.file_lock import file_lock as _file_lock
...
from interview_plugin_core.prompt_loader import load_agent_prompt, load_persona_prompt_data
from interview_plugin_core.security import InputValidator
from interview_plugin_core.types import Result
...
class InterviewEngine:
    ...
    Note:
        The model defaults to INTERVIEW_CODEX_MODEL or ``"default"`` and can
    ...
    async def start_interview(
        ...
        # Auto-detect brownfield projects from CWD using the portable detector.
        # codebase_paths is informational only — the calling runtime handles any
        # richer codebase exploration outside this package.
        if cwd:
    ...
    def _build_ambiguity_snapshot_prompt(self, state: InterviewState) -> str:
        ...
        from interview_plugin_core.ambiguity import (
            AMBIGUITY_THRESHOLD,
    ...
    def _select_perspectives(self, state: InterviewState) -> tuple[InterviewPerspective, ...]:
        ...
        from interview_plugin_core.ambiguity import SEED_CLOSER_ACTIVATION_THRESHOLD
